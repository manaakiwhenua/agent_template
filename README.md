...
If total economic value has decreased in the last model iteration then perform the following actions.
 ...
 - Randomly select `industry-rule-percentage` of patches with current land use 3 and assign new land uses from a random selection of 4 or 6.
 - Randomly select `industry-rule-percentage` of patches with current land use 6 and assign a new land use of 4.
 - Randomly select `industry-rule-percentage` of patches with current land use 7 and assign new land uses from a random selection of 3, 4 or 6.
...
If total emissions have increased in the last model iteration then perform the following actions.
 ...
 - Randomly select `government-rule-percentage` of patches with current land use 6 and assign new land uses from a random selection of 3 or 4.
 - Randomly select `government-rule-percentage` of patches with current land use 7 and assign a new land use of 9.
