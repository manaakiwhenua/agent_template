...
The weights of the various land uses are initially zero apart from the current land use that is set to one.
This fixed value sets the scale of user-configurable rule weights.
